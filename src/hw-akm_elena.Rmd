...
print("proportion of firms in the connected set")
...
print("firm effect")
print(c(var(data$psi),var(data$psi_hat)))
print("worker effect")
print(c(var(data$alpha),var(data$alpha_hat)))
print("sorting")
print(c(cov(data$alpha,data$psi),cov(data$alpha_hat,data$psi_hat)))
